// Run with: npm run example:charts   — or the button on the charts slide.
//
// Copied from `@react-x11/components`' own `examples/charts.tsx`, with the
// import repointed from `../src/index.js` to the published package. It is a
// separate process with its own window on purpose: the slide's point is what
// a chart costs on the wire as the data grows, and the honest way to show
// that is a real app with its own connection, its own HUD and its own frame
// clock — not a panel sharing this deck's.
//
